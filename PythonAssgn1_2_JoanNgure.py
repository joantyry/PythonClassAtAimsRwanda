...
def Times():
	...
	"""
	n = int(input("Enter the number of times you want to print out x "))
	print 'x'*n
...
def numbers():
    ...
    if j == 0:
        ...
        h = input("Enter any real number for example -2.5,1,9.8 ")
        t = pow(h,5)
        print "%.10f" %t
    elif j==2:
...
def smallest():
	...
	"""  
	mylist =list()
	print "You are supposed to enter four numbers"
	for p in range(1,5):
		
		k = int(input("Please enter your number %d and press enter :"%p))
		mylist.append(k)
	print "Your minimum number is", min(mylist)  
...
def Quadratic():
    ...
    """    
    r,t,y = input("Please input three numbers a,b,c separated by commas ")
    d = (t**2) - (4*r*y) 
    if r == 0:
	print "a cannot be 0"
    elif d > 0:
	...
	sol1 = (-t-cmath.sqrt(d))/(2*r)
	sol2 = (-t+cmath.sqrt(d))/(2*r)
	print 'The solutions are {0} and {1}'.format(sol1,sol2)
...
def intger():
    ...
    print "The numbers divisible by 5 but not 3 or 7, between 1 and 250 are: ", len(lis)

def Reduce():
	"""
	Note3 15
	Write a program (Reduce.py) that given a list of numbers, returns a sorted list where no element is
	repeated. So [1, 2, 2, 3, 4, 2, 1] will yield [1, 2, 3, 4]
	"""
	p = input("How many numbers do you want to sort?")
	w = []
	for i in range(1,p+1):
		h = input("Enter your number %d :" %i)
		w.append(h)
	w.sort()#sort because you convert it to a list after setting
	w = set(w)
	w = list(w)
...
def plotting():
	...
	pl.plot(x,y)
	pl.title("Plot of $f(x) = ln(x^2 + e^{2x} )$ ")
	pl.xlabel("x axis")
	pl.ylabel("y axis")
	#pl.xlim(-3, 3)
	#pl.ylim(0,10)
...
def guassian2():
	...
	for x0 in s:
		...
		pl.title("Guassian Distribution with respect to x0")
		pl.xlabel('x0')
		pl.ylabel('y-axis')
...
def guassian3():
	...
	for sigma in s:
		pl.plot(guassian(np.linspace(-10,10 , 100), sigma,x0))
		pl.title("Guassian Distribution with respect to sigma")
		pl.xlabel('sigma')
		pl.ylabel('$y- axis')
...
if __name__ == "__main__":
    ...
    CelciusToFahrenheit()
    raw_input("press enter to continue with the calculation of the hypotenuse ")
    print('****************************************************************')	
    	
    CalLength()
    raw_input("press enter to move to the calculation of the total amount ")
    print('****************************************************************')

    totalamount()
    raw_input("press enter to continue with the evaluator problem ")
    print('****************************************************************')

    Evaluator()
    raw_input("press enter to continue with the calulation of newtons law of cooling ")
    print('****************************************************************')

    Newtons()
    raw_input("press enter to check the retirement total savings ")
    print('****************************************************************')

    RetirementSavings()
    raw_input("press enter to continue with sum,average and difference of numbers challenge")
    print('****************************************************************')

    Numbers()
    raw_input("press enter to continue to output a character the number of times you want")
    print('****************************************************************')

    Times()
    raw_input("press enter to print out your largest number ")
    print('****************************************************************')

    Largest()
    raw_input("press enter to execute f(x,y) ")
    print('****************************************************************')

    Value()
    raw_input("press enter to check whether a year is leap or not ")
    print('****************************************************************')

    LeapYear()
    raw_input("press enter to find co-ordinates of intersection ")
    print('****************************************************************')

    Coefficient()
    raw_input("press enter to evaluate a geometric sequence")
    print('****************************************************************')

    Large()
    raw_input("press enter to see the results of manipulating a string ")
    print('****************************************************************')

    Abbas()
    raw_input("press enter to print out the quotient of two numbers")
    print('****************************************************************')

    quo()
    raw_input("press enter to play a game with numbers ")
    print('****************************************************************')

    numbers()
    raw_input("press enter to find the smallest number ")
    print('****************************************************************')

    smallest()
    raw_input("press enter to play a manupilation game with strings  ")
    print('****************************************************************')

    string()
    raw_input("press enter to continue with adding either 'ing' or 'ly' to a string ")
    print('****************************************************************')

    ing()
    raw_input("press enter to solve a quadratic equation ")
    print('****************************************************************')

    Quadratic()
    raw_input("press enter to get the largest odd divisor of a number ")
    print('****************************************************************')

    LargestOddDivisor()
    raw_input("press enter to check the numbers divisible by 5 only ")
    print('****************************************************************')

    intger()
    raw_input("press enter to get a list of sorted non-repetive numbers ")
    print('****************************************************************')

    Reduce()
    raw_input("press enter to arrange your numbers in ascending order ")
    print('****************************************************************')

    ordering()
    raw_input("press enter to check the grades of a student ")
    print('****************************************************************')

    grades()
    raw_input("press enter to generate random numbers")
    print('****************************************************************')

    Counting(100000)
    raw_input("press enter to continue with plotting ")
    print('****************************************************************')

    plotting()
    raw_input("press enter to continue with curves")
    print('****************************************************************')
    ...
    guassian2()
    raw_input("press enter to continue with guassian distribution ")
    print('****************************************************************')
